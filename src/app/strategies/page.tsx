      ...
      <nav style={{
        ...
        <div style={{ maxWidth: 1240, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: 66, padding: "0 28px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 22 }}>
            ...
            <Link href="/#calendar" style={{ color: "var(--td)", fontSize: 10.5, fontWeight: 500, letterSpacing: 1.8, textTransform: "uppercase" as const, textDecoration: "none" }}>Calendar</Link>
