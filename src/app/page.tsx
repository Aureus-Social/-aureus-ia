  ...
  return (
    <div dir={isRtl ? "rtl" : "ltr"}>
      ...
      <section id="discovery"><div className="mx">
        <FI><div className="dc">
          <img src="https://upload.wikimedia.org/wikipedia/commons/2/2f/Benjamin_Franklin_by_Joseph_Duplessis_1778.jpg" alt="Benjamin Franklin" style={{ width: 200, height: 200, objectFit: "cover", objectPosition: "center 15%", borderRadius: "50%", margin: "0 auto 24px", display: "block", border: "3px solid rgba(201,168,76,.3)" }} />
